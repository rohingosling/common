...
namespace common
{
	...
	// DESCRIPTION:
	//
	// - Takes an input integer 'i', and generates a 'width' character long string representation of the input integer, that is left padded
	//   with the specified charachter 'ch'.
	//
	// ARGUMENTS:
	//
	// - i
	...
	//
	//   e.g 1.
	//   - If i = 123, and ch = '0', and width = 8, then the output string will be,   "00000123"
	//                                                                                 |'|'|'|'_
	//                                                                                 0 2 4 6 8  	
	//   e.g 2.
	//   - If i = 1000, and ch = '.', and width = 16, then the output string will be, "............1000"
	//                                                                                 |'''|'''|'''|'''_
	//                                                                                 0   4   8   12  16
	//   e.g 3.
	//   - If i = 256, and ch = ' ', and width = 10, then the output string will be,  "       256"
	//                                                                                 |'''|'''|'_
	//                                                                                 0   4   8 10
	// - width
	//   - The character length of the output string.
	//   - If width is less characters than the number of digits making up the input integer, then the string representation of the integer
	//     will be truncated.
	//
	// RETURN VALUE:
	//
	// - A left padded string representation on the input integer.
	//
	// PRE-CONDITIONS:
	//
	// - N/A
	...
	// POST-CONDITIONS:
	//
	// - A left padded string representation of the input integer has been returned.
	//
	//--------------------------------------------------------------------------------------------------------------------------------------
