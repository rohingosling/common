...
namespace common
{
	...
	public:
		...
		static void clear_console ();						// Clear the console.
		static void move_to       ( int x, int y );			// Move the cursor to the location specified by (x,y);
