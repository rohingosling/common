...
NeuralNetworkApplication::NeuralNetworkApplication ( int argc, char* argv [] ) : ConsoleApplication { argc, argv }
{
}
...
void NeuralNetworkApplication::command_interpreter ( vector <string> command_line ) 
{
...
void NeuralNetworkApplication::command_main_program ()
{
...
void NeuralNetworkApplication::command_test_1 ()
{
	// Declare local variables.
...
void NeuralNetworkApplication::command_test_2 ()
{
#if 0
	// Declare local variables.
...
void NeuralNetworkApplication::command_test_3 ()
{
#if 0
	// Display test info.
...
void NeuralNetworkApplication::command_test_4 ()
{
#if 0
	// Display test info.
...
void NeuralNetworkApplication::command_test_5 ()
{
#if 0
...
void NeuralNetworkApplication::print_program_info ()
{
...
void NeuralNetworkApplication::print_program_info ( string class_name, string function_name, string description )	
{
	cout << endl;
...
void NeuralNetworkApplication::print_vector ( vector <double> v, int precision, string label, string vector_name )
{
	// Define lambdas
...
string NeuralNetworkApplication::log_to_string ( long long time_point, long long time_stop, string message )
{
	...
	string s_time { StopClock::time_to_string ( elappsed_time ) };
