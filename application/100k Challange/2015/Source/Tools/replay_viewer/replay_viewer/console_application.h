...
private:
	...
	const string C_MSG_EXECUTION_TIME    = "Execution time (seconds.ms):";		
...
private:
	...
	string print_execution_time ( double seconds );
	string print_execution_time ( int margin, double seconds );
