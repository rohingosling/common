...
void ConsoleApplication::run ( )
{
	...
	__int64	delta_time = duration_cast < milliseconds > ( elapsed_time ).count ( );
	double	seconds    = delta_time / 1000.0;

	// Display the elapsed time.

	cout << print_execution_time ( seconds ) << endl;
}
...
string ConsoleApplication::print_execution_time ( double seconds )
{
	return print_execution_time ( this->margin, seconds );
}
...
string ConsoleApplication::print_execution_time ( int margin, double seconds )
{
	// Constants
