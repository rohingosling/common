...
// Pre-Conditions:
//
// - A list of zero or more strings in the form of an STL vector <string>, should
//   be pre-popilated for use.
//
// - In the case of an empty vecotor, the function returns zero.
//   
// Post-Conditions:
//
// - An integer representing the length of the longest string in the vector is 
...
// Post-Conditions:
//
// - A new copy of the strings is created and converted to an all upper case
//   verions of inputString.
//
//------------------------------------------------------------------------------------------------------------------
...
// Description:
//
// - Searches for all occurences of a substring in inputString, and replace all 
//   occurances of the found substring with a replacement string.
//
// Arguments:   
//
// - inputString:
...
//
//   - We will make a copy of this string, so the original sring used to supply
//     the argument will remain unchanged.
//
// - search:
//
...
// Post-Conditions:
//
// - A copy of the input string, with all occureances of search, replaced
//   by, replace.
//
// - The original input string used for the input string argument, will
//   remain unchanged.
//
//------------------------------------------------------------------------------------------------------------------
